...
<%
	...
	String oldFare = request.getParameter("oldFare");
%>
   		...
   		<div class="flex-nav">
			...
			<div class="userCard">
   			...
   			<form action="./updateSchedule.jsp">
				<div class="container">
					   <div class="heading">Changing fare:</div>
					   <input type="text" name="oldName" value="<%=oldName%>" class="hide">
					   <input type="text" name="oldTid" value="<%=oldTid%>" class="hide">
					   <input type="text" name="newFare" value="<%=oldFare%>">
					   <div class="original">Original fare: <%=oldFare%></div>
