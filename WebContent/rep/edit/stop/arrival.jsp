...
if (session.getAttribute("user") == null || session.getAttribute("userType") == null || !session.getAttribute("userType").equals("rep")) {
	...
	String oldArrival = request.getParameter("arrival");
   		...
   		<div class="flex-nav">
			...
			<div class="userCard">
   			...
   			<form action="./updateStop.jsp">
				<div class="container">
					   <div class="heading">Changing arrival:</div>
					   ...
					   <input type="text" name="arrival" value="<%=DATE_FORMAT.format(timestamp)%>">
					   <div class="original">Original arrival: <%=DATE_FORMAT.format(timestamp)%></div>
